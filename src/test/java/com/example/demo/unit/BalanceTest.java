...
public class BalanceTest {
    ...
    @DisplayName("새로운 계좌에 첫 충전 시 잔액이 정상 저장된다.")
    @Test
    void charge_success_1() {
        // given
        Long userId = 1L;
